...
AutoLevelController::AutoLevelController(DataManager& data_manager)
    : Controller(data_manager),
      ...
      m_roll_angle_pid(1.0f, 0.0f, 0.0f),
      m_pitch_angle_pid(1.0f, 0.0f, 0.0f),

      m_roll_rate_pid(0.05f, 0.0f, 0.005f),
      m_pitch_rate_pid(0.05f, 0.0f, 0.005f),
      m_yaw_rate_pid(0.05f, 0.0f, 0.0f),
